...
export interface IReportService {
  ...
  getTopTransporters(filters: ReportFilters, limit?: number): Promise<TopTransporter[]>;
  getOrderStats(filters: ReportFilters): Promise<OrderStats>;
  getDeliveryRequestStats(filters: ReportFilters): Promise<DeliveryRequestStats>;
